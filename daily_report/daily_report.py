...
# ./data/projections/rotogrinders/YYYY-MM-DD.csv
...
def fetch_roto_ql_projection(year, month, day):
    ...
    proj_df.to_csv('./data/projections/rotoql/%s-%s-%s.csv' %
                   (year, month, day))
    return proj_df
...
def daily_report(year, month, day):
    ...
    join_res_rg = dk_res_df.set_index('Name').join(rg_proj.set_index('Name'), how='inner', on='Name', lsuffix='_res', rsuffix='_rg')[
        ['Date', 'DK Pts', 'Projection', 'DK Salary_rg']].fillna(0)
    join_res_rg.columns = ['Date', 'DK Pts', 'RG Proj', 'DK Salary']
    join_res_rg = join_res_rg.join(
        ql_proj, how='inner', on='Name', lsuffix='_res', rsuffix='_rg').fillna(0)
    join_res_rg.columns = ['Date', 'DK Pts', 'RG Proj',
                           'DK Salary', 'GR Proj', '5AVG', 'RQ Proj', 'SAVG']
    join_res_rg['RG MAE'] = abs(join_res_rg['DK Pts'] - join_res_rg['RG Proj'])
    join_res_rg['RG RMSE'] = pow(
        join_res_rg['DK Pts'] - join_res_rg['RG Proj'], 2)
    join_res_rg['RG MAE Percent'] = join_res_rg[
        'RG MAE'] / join_res_rg['DK Pts']
    join_res_rg['RQ MAE'] = abs(join_res_rg['DK Pts'] - join_res_rg['RQ Proj'])
    join_res_rg['RQ RMSE'] = pow(
        join_res_rg['DK Pts'] - join_res_rg['RQ Proj'], 2)
    join_res_rg['RQ MAE Percent'] = join_res_rg[
        'RQ MAE'] / join_res_rg['DK Pts']
    join_res_rg['GR MAE'] = abs(join_res_rg['DK Pts'] - join_res_rg['GR Proj'])
    join_res_rg['GR RMSE'] = pow(
        join_res_rg['DK Pts'] - join_res_rg['GR Proj'], 2)
    join_res_rg['GR MAE Percent'] = join_res_rg[
        'GR MAE'] / join_res_rg['DK Pts']
    join_res_rg['5AVG MAE'] = abs(join_res_rg['DK Pts'] - join_res_rg['5AVG'])
    join_res_rg['5AVG RMSE'] = pow(
        join_res_rg['DK Pts'] - join_res_rg['5AVG'], 2)
    join_res_rg['5AVG MAE Percent'] = join_res_rg[
        '5AVG MAE'] / join_res_rg['DK Pts']
    join_res_rg['SAVG MAE'] = abs(join_res_rg['DK Pts'] - join_res_rg['SAVG'])
    join_res_rg['SAVG RMSE'] = pow(
        join_res_rg['DK Pts'] - join_res_rg['SAVG'], 2)
    join_res_rg['SAVG MAE Percent'] = join_res_rg[
        'SAVG MAE'] / join_res_rg['DK Pts']
    join_res_rg['DK Pts/k'] = join_res_rg['DK Pts'] / \
        join_res_rg['DK Salary'] * 1000
    ...
    # print ""
    # print "Top 10 miss:"
    # print join_res_rg.sort_values(by=['RG MAE Percent'],
    ...
    # print ""
    # print "Top 10 miss:"
    # print join_res_rg.sort_values(by=['RQ MAE Percent'],
    # ascending=False).head(10)
    print ""
    ...
    # print ""
    # print "Top 10 miss:"
    # print join_res_rg.sort_values(by=['GR MAE Percent'],
    # ascending=False).head(10)
    print ""
    ...
    # print ""
    # print "Top 10 miss:"
    # print join_res_rg.sort_values(by=['5AVG MAE Percent'],
    # ascending=False).head(10)
    print ""
    ...
    # print ""
    # print "Top 10 miss:"
    # print join_res_rg.sort_values(by=['SAVG MAE Percent'],
    # ascending=False).head(10)
